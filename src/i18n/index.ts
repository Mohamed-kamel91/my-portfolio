...
const initI18next = async (
  ...
  // Create a new instance for each render on server side, because during compilation everything seems to be executed in parallel
...
type $FirstNamespace<Ns extends Namespace> =
